...
namespace hal
{
    ...
    public:
        ...
        services::GattRequestStatus Update(const services::GattServerCharacteristicOperationsObserver& characteristic, infra::ConstByteRange data) const override;
    ...
    protected:
        ...
        void HandleAttExchangeMtuResponse(const aci_att_exchange_mtu_resp_event_rp0& event) override;
